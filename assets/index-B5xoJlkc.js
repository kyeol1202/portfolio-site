...
react_production.cloneElement = function(element, config, children) {
  ...
  var props = assign$2({}, element.props), key = element.key;
  if (null != config)
...
var Ye = new Ae(), We = $e(), qe = React$2.createContext({ shouldForwardProp: void 0, styleSheet: Ye, stylis: We });
qe.Consumer;
React$2.createContext(void 0);
function Je() {
  return React$2.useContext(qe);
}
var Ze = React$2.createContext(void 0);
Ze.Consumer;
var tt = {};
function ot(e2, s2, i2) {
  var a2 = se(e2), c2 = e2, u2 = !z(e2), p2 = s2.attrs, h2 = void 0 === p2 ? P$2 : p2, d2 = s2.componentId, f2 = void 0 === d2 ? function(e3, t2) {
    ...
    return z(e3) ? "styled.".concat(e3) : "Styled(".concat(B$1(e3), ")");
  ...
  function E2(e3, s3) {
    return function(e4, s4, i3) {
      var a3 = e4.attrs, c3 = e4.componentStyle, u3 = e4.defaultProps, l2 = e4.foldedComponentIds, p3 = e4.styledComponentId, h3 = e4.target, d3 = React$2.useContext(Ze), f3 = Je(), m3 = e4.shouldForwardProp || f3.shouldForwardProp;
...
const Logo = ut.span`
  ...
  color: #4a9eff;
`;
const NavLinks$1 = ut.ul`
  list-style: none;
  display: flex;
  gap: 2rem;
`;
const NavLink$1 = ut.a`
  color: #e0e0e0;
...
function Navbar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Nav, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { children: "kyeol.dev" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(NavLinks$1, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink$1, { href: "#about", children: "About" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink$1, { href: "#skills", children: "Skills" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink$1, { href: "#projects", children: "Projects" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink$1, { href: "#contact", children: "Contact" }) })
    ] })
  ] });
}
...
const ClickHint$1 = ut.div`
  ...
  animation:
    ...
    ${clickPulse$1} 2s  ease       ${ASSEMBLE_DONE + 1.5}s  infinite;
  pointer-events: none;
`;
const artistAppear = ft`
...
const ArtistBtn = ut.button`
  ...
  z-index: 10;
`;
const ArtistBtnIcon = ut.div`
  font-size: 1.8rem;
  line-height: 1;
`;
const ArtistBtnLabel = ut.span`
  font-size: 0.6rem;
  font-weight: 700;
...
function Hero({ onExitComplete, onArtistClick }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section$5, { $exiting: phase === "exiting", onClick: handleClick, id: "hero", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(TextBlock, { $phase: phase, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Description, { children: "Java · Spring Boot · Python을 주력으로 하는 개발자입니다. 데이터 자동화, ERP 시스템, 웹 서비스 개발 경험을 보유하고 있으며 실용적이고 유지보수하기 좋은 코드를 추구합니다." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ArtistBtn, { onClick: handleArtist, title: "3D Artist Portfolio", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ArtistBtnIcon, { children: "✦" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ArtistBtnLabel, { children: "Artist" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ArtistBtnArrow, { children: "›" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ClickHint$1, { children: "— CLICK ANYWHERE TO ENTER —" })
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section$4, { id: "about", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.05, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ProfileRow$1, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ProfileRight$1, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(InfoGrid$1, { children: infoItems$1.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(InfoCard$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(InfoText$1, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.2, direction: "right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SubSection$1, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(ItemList$1, { as: "ul", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(ActivityItem$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ActivityBody$1, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(ActivitySub$1, { children: "서강대 미래교육원 — 게임 개발 · 2023 부회장 역임" })
            ] }) })
          ] })
        ] }) })
      ] })
...
const CategoryLabel = ut.h3`
  ...
  text-transform: uppercase;
`;
const SkillList$1 = ut.div`
  display: flex;
  flex-direction: column;
  gap: 0.65rem;
`;
const SkillRow$1 = ut.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 1rem;
...
function Skills() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section$3, { id: "skills", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Grid$1, { children: categories.map((cat, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 0.08, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CategoryCard, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryLabel, { children: cat.label }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SkillList$1, { children: cat.skills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SkillRow$1, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SkillName$1, { children: skill.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dots$1, { children: [1, 2, 3, 4, 5].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Dot$2, { $filled: n <= skill.level }, n)) })
      ] }, skill.name)) })
    ] }) }, cat.label)) })
  ] });
}
...
`;
const CardName$1 = ut.h3`
  color: #fff;
  font-size: 1rem;
  font-weight: 700;
  margin-bottom: 0.4rem;
`;
const CardDesc$1 = ut.p`
  color: #888;
  font-size: 0.83rem;
  line-height: 1.6;
  margin-bottom: 1rem;
`;
const TagRow$1 = ut.div`
  display: flex;
  flex-wrap: wrap;
  gap: 0.4rem;
`;
...
function Projects() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section$2, { id: "projects", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Grid, { children: projects.map((p2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card$1, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Thumb$1, { $bg: BG$2[i % BG$2.length] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardBody$1, { children: [
        p2.github && /* @__PURE__ */ jsxRuntimeExports.jsx(GitLink, { href: p2.github, target: "_blank", rel: "noreferrer", children: "GitHub ↗" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardName$1, { children: p2.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDesc$1, { children: p2.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TagRow$1, { children: p2.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { children: tag }, tag)) })
      ] })
    ] }) }, p2.name)) })
  ] });
}
...
const makePulseRing = (hex) => {
  ...
  return ft`
    0%, 100% { box-shadow: 0 0 10px rgba(${r},${g},${b2},0.2), inset 0 0 10px rgba(${r},${g},${b2},0.04); }
    50%       { box-shadow: 0 0 30px rgba(${r},${g},${b2},0.5), inset 0 0 20px rgba(${r},${g},${b2},0.08); }
  `;
};
const hexToRgba = (hex, a2) => {
  const r = parseInt(hex.slice(1, 3), 16);
  const g = parseInt(hex.slice(3, 5), 16);
  const b2 = parseInt(hex.slice(5, 7), 16);
...
`;
function CustomCursor({ isLanding, color = "#4a9eff" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dot$1, { ref: dotRef, $visible: visible, $color: color }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Ring, { ref: ringRef, $visible: visible, $isLanding: isLanding, $color: color, children: [
      isLanding && /* @__PURE__ */ jsxRuntimeExports.jsx(SpinBorder, { $color: color }),
      isLanding && /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { $color: color, children: "NEXT" })
    ] })
  ] });
}
const COLS = 28;
...
const TILE_DUR = 0.45;
const SPEED = 0.026;
const tileFlash = (from2, mid, to) => ft`
  0%   { opacity: 0; transform: scale(0.6); background: ${from2}; }
...
function WaveTransition({ active, toArtist, originX = 0.85, originY = 0.5, onComplete }) {
  const tiles = reactExports.useMemo(() => {
    ...
    for (let r = 0; r < ROWS; r++) {
      for (let c2 = 0; c2 < COLS; c2++) {
        const dist = Math.sqrt((c2 - oc) ** 2 + (r - or) ** 2);
        const delay = dist * SPEED;
        if (delay > maxDelay) maxDelay = delay;
        list.push({ c: c2, r, delay });
      }
    }
  ...
  reactExports.useEffect(() => {
    if (!active) return;
    const total = (tiles.maxDelay + TILE_DUR + 0.1) * 1e3;
    const t = setTimeout(() => onComplete == null ? void 0 : onComplete(), total);
    return () => clearTimeout(t);
  }, [active, tiles.maxDelay, onComplete]);
  if (!active) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Overlay, { children: tiles.list.map(({ c: c2, r, delay }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    Tile,
    {
      $delay: delay,
      $toArtist: toArtist,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { id: "a-about", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.05, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ProfileRow, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ProfileRight, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(InfoGrid, { children: infoItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(InfoCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(InfoText, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.2, direction: "right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SubSection, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(ItemList, { as: "ul", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(ActivityItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ActivityBody, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(ActivitySub, { children: "서강대 미래교육원 — 게임 개발 · 2023 부회장 역임" })
            ] }) })
          ] })
        ] }) })
      ] })
...
`;
const LandingSection = ut.section`
  position: fixed;
  inset: 0;
  display: flex;
  align-items: center;
...
ut.span`font-size: 1rem; flex-shrink: 0;`;
...
const personalWorks = [
  {
    ...
    tags: ["Unreal Engine", "3DsMax", "Substance Painter", "Zbrush", "Photoshop"],
    link: null
  },
  {
    name: "개인 작업 2",
    desc: "포스트아포칼립스 3D 배경 작업물.",
    bg: "linear-gradient(135deg,#001a2a,#0a1a00)",
    tags: ["Unreal Engine", "3DsMax", "Substance Painter", "Photoshop", "Marmoset Toolbag"],
    link: null
  },
  {
    name: "개인 작업 3",
    desc: "중세 판타지 3D 오브젝트 작업물.",
    bg: "linear-gradient(135deg,#0a001a,#1a0a00)",
    tags: ["Unreal Engine", "3DsMax", "Substance Painter", "Photoshop", "Zbrush"],
    link: null
  }
];
const projectWorks = [
...
function ArtistPage({ onBackToDev, onLandingDone }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    isLanding && /* @__PURE__ */ jsxRuntimeExports.jsxs(LandingSection, { $exiting: phase === "exiting", onClick: handleLandingClick, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DevBtn, { onClick: handleDevBtn, title: "Developer Portfolio", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DevBtnIcon, { children: "⟨" }),
    ...
    isPortfolio && /* @__PURE__ */ jsxRuntimeExports.jsxs(PageWrap, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ArtistNav, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(NavLogo, { children: "kyeol.art" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(NavLinks, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { href: "#a-about", children: "About" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { href: "#a-skills", children: "Skills" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { href: "#a-personal", children: "Works" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { href: "#a-projects", children: "Projects" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SecWrap, { id: "a-skills", $alt: true, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SkillGrid, { children: artistSkills.map((cat, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 0.08, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SkillCard, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SkillCardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SkillCardLabel, { children: cat.label }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SkillList, { children: cat.skills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SkillRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SkillLeft, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SkillName, { children: skill.name }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Dots, { children: [1, 2, 3, 4, 5].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Dot, { $f: n <= skill.level }, n)) })
          ] }, skill.name)) })
        ] }) }, cat.label)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SecWrap, { id: "a-personal", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SecTitle, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "#" }),
            " Personal Works"
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardGrid, { children: personalWorks.map((w2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 0.12, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Thumb, { $bg: w2.bg }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SecWrap, { id: "a-projects", $alt: true, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SecTitle, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "#" }),
            " Projects"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SecWrap, { id: "a-contact", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LinkGroup, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CLink, { href: "https://www.artstation.com/hankyeolkim", target: "_blank", children: "🎨 artstation.com/hankyeolkim" })
        ] }) })
      ] }),
