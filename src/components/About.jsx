          ...
          <Reveal delay={0.1} direction="right">
            <SubSection>
              ...
              <ItemList>
                ...
                <Item>
                  정보처리기사<PlanBadge>2026 취득예정</PlanBadge>
                </Item>
                <Item>
                  토익스피킹 140점<PlanBadge>2026 취득예정</PlanBadge>
                </Item>
                <Item>
                  JLPT N3<PlanBadge>2026 취득예정</PlanBadge>
                </Item>
                <Item>
                  ADsP (데이터분석 준전문가)<PlanBadge>2026 취득예정</PlanBadge>
                </Item>
              </ItemList>
            </SubSection>
          </Reveal>
